...
async function main(){ 
  ...
  await fraction_contract.Intialize(nft_collection_address,tokenid);
  ...
  const dutch_auction=await Dutch_Auction.deploy(startingprice,params.discountRate,fractional_contract_address,params.timeperiod);
